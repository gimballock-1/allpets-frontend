...
export const SiteSettingSchema = z.object({
  ...
  phoneE164: z.string().regex(/^\+\d{7,15}$/, "must be E.164, e.g. +14055550123"),
  ...
  /** Exactly the 7 weekdays; the Contact page + schema.org format from this. */
...
// ── Reviews (runtime, consumed from Spring GET /reviews via the proxy) ───────
